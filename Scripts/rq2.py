...
plt.figlegend([r1, r2, r3, r4, r5], ["NSGAII", "SPEA2", "GALE", "GALE-S-NM", "GALE-S-LP"], frameon=False, loc='upper center', bbox_to_anchor=(0.5, 1.023), fancybox=True, ncol=5)
...
plt.tight_layout()
# plt.show()
plt.savefig('rq2.eps', format='eps')