...
r6 = ax1.bar(index + 5*bar_width, get_data("GALE_LP_I", "hv"), bar_width,alpha=opacity,color='#00D9FA',error_kw=error_config)
# ax1.set_xlim(5, 190)
# ax1.set_ylim(0, 119)
...
r6 = ax2.bar(index + 5*bar_width, get_data("GALE_LP_I", "spread"), bar_width,alpha=opacity,color='#00D9FA',error_kw=error_config)
ax2.set_xlim(10, 300)
